    ...
    <div class="flex items-center gap-3">
        <div class="flex items-center gap-3">
            <div class="text-right">
                ...
                <span class="bg-secondary/10 text-secondary text-[10px] px-2 py-0.5 rounded font-label-caps tracking-[0.18em] uppercase">Faculty</span>
            </div>
        ...
        <section class="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
            ...
            <div class="px-4 pb-6 -mt-10 relative flex flex-col items-center gap-4 text-center md:px-8 md:flex-row md:items-end md:gap-6 md:text-left">
                ...
                <div class="flex-1 pb-2">
                    ...
                    <div class="flex flex-wrap justify-center gap-x-6 gap-y-1 mt-1 text-on-primary-container text-sm md:justify-start">
