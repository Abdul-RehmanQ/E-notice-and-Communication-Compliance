...
<head>
    ...
    <title>EduCompliance Hub - Login</title>
...
<body class="bg-background font-body-md text-on-background academic-mesh min-h-screen flex items-center justify-center p-6">
    <main class="w-full max-w-[1100px] grid grid-cols-1 md:grid-cols-12 bg-white rounded-xl shadow-xl shadow-slate-200/50 overflow-hidden border border-outline-variant">
        <section class="md:col-span-5 bg-primary-container p-12 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10 pt-12">
                <p class="font-body-sm text-sm text-on-primary-container/70">
                    (c) 2026 University Administration System.<br>
        ...
        <section class="md:col-span-7 p-12 bg-white flex flex-col justify-center">
            <div class="mb-10">
                <h2 class="font-h2 text-3xl text-primary mb-2">Student Login</h2>
            ...
            <form method="POST" action="" class="space-y-6">
                <div class="grid grid-cols-1 gap-6">
                    <div class="relative">
                        <label class="font-label-caps text-xs tracking-wider text-on-surface-variant block mb-2" for="rollNumber">ROLL NUMBER</label>
                        <div class="relative group">
                            <span class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline group-focus-within:text-secondary">badge</span>
                            <input
                                class="w-full pl-12 pr-4 py-3.5 bg-surface-container-low border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-secondary/20 focus:border-secondary outline-none transition-all placeholder:text-outline-variant"
                                id="rollNumber"
                                name="rollNumber"
                                placeholder="e.g. 2024-ENG-001"
                                value="<?php echo htmlspecialchars($submittedRollNumber); ?>"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative group">
                            ...
                            <input
                                class="w-full pl-12 pr-12 py-3.5 bg-surface-container-low border border-outline-variant rounded-lg font-body-md focus:ring-2 focus:ring-secondary/20 focus:border-secondary outline-none transition-all placeholder:text-outline-variant"
                                id="password"
                                name="password"
                                type="password"
            ...
            <div class="mt-12 pt-8 border-t border-outline-variant">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <a href="community_supervisor/login.php" class="flex flex-col items-center gap-2 p-4 rounded-xl border border-outline-variant hover:border-secondary hover:bg-secondary/5 transition-all group" aria-label="Supervisor login">
                        <span class="material-symbols-outlined text-outline group-hover:text-secondary">verified_user</span>
                        <span class="font-label-caps text-[10px] tracking-wider">SUPERVISOR</span>
                    </a>
